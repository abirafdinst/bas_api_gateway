...
func (a *authImplement) Login(g *gin.Context) {
	...
	usecase.NewLogin().Authentication(bodyPayloadAuth.Username, bodyPayloadAuth.Password)

	if usecase.NewLogin().Authentication(bodyPayloadAuth.Username, bodyPayloadAuth.Password) {
